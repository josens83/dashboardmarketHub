...
const TeamManagement: React.FC = () => {
  ...
  const getRoleBadge = (role: TeamMember['role']) => {
    const badges = {
      owner: { label: '소유자', color: 'bg-brand-600', icon: <Crown className="w-3 h-3" /> },
      admin: { label: '관리자', color: 'bg-sapphire-600', icon: <Shield className="w-3 h-3" /> },
  ...
  if (user?.subscriptionTier !== 'enterprise') {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-brand-600 to-indigo-600 rounded-xl p-8 text-white text-center">
          <Users className="w-16 h-16 mx-auto mb-4 opacity-90" />
          <h2 className="text-3xl font-bold mb-3">팀 협업 기능</h2>
          <p className="text-lg mb-6 text-brand-100">
          ...
          <button className="px-8 py-3 bg-white text-brand-700 rounded-lg font-bold text-lg hover:bg-brand-50 transition-colors">
            엔터프라이즈 플랜으로 업그레이드
          </button>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-10 h-10 bg-brand-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
              ...
              <tr key={member.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-brand-600 to-sapphire-600 rounded-full flex items-center justify-center text-white font-semibold">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {member.role === 'member' && (
                        <button
                          ...
                          className="text-sm text-sapphire-600 hover:text-blue-700 font-medium"
                        >
                          관리자로 승격
                        </button>
                      )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-600 focus:border-transparent text-gray-900 dark:text-white"
                  />
                </div>
              </div>
